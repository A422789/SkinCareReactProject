    ...
    <section style={{ marginTop: '5rem' }} aria-label="Related products">
      ...
      >
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
          <span style={{ fontSize: '0.75rem', letterSpacing: '0.35em', textTransform: 'uppercase', color: 'var(--gold)' }}>Complete the Ritual</span>
          <h2 className="font-serif" style={{ fontSize: '1.875rem', color: 'var(--foreground)' }}>You May Also Love</h2>
        </div>
